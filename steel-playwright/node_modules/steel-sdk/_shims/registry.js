...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'steel-sdk/shims/${shims.kind}'\` before importing anything else from steel-sdk`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'steel-sdk/shims/${shims.kind}'\` after \`import 'steel-sdk/shims/${exports.kind}'\``);
    }
