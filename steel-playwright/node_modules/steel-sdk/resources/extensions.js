...
class Extensions extends resource_1.APIResource {
    update(extensionId, body = {}, options) {
        if ((0, core_1.isRequestOptions)(body)) {
            return this.update(extensionId, {}, body);
        }
        return this._client.put(`/v1/extensions/${extensionId}`, Core.multipartFormRequestOptions({ body, ...options }));
    }
    /**
